<template>
    <section class="py-12 md:py-24 px-4 md:px-6">
        <div class="max-w-screen-xl w-full m-auto text-lg grid md:grid-cols-2 gap-4 items-center">
            <div>
                <b>Q-TERM</b> are o istorie lungă în ceea ce privește designul și dezvoltarea produselor de încălzire durabilă care excelează în mediul 
