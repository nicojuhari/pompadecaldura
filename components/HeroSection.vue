    ...
    <section class="py-12 md:py-24 px-4 md:px-6">
        <div class="max-w-screen-xl w-full m-auto">
            <div class="text-center text-2xl md:text-7xl leading-tight">
                ...
                <div class="md:text-4xl mt-4 md:mt-6 opacity-70"><em>Încălzire, Apă caldă și Răcirea locuinței</em></div>
            </div>
            <div class="mt-8">
                ...
                <div class="text-2xl md:text-4xl text-center mt-4">
                    <span class="text-brand font-bold ">Mai ieftin de 3 ori,</span> decât cu GAZ, cărbune, sau lemne 🔥
                </div>
            </div>
        </div>
    </section>
